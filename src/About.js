    ...
    return(
        <div>
            ...
            <div class="Services text-center d-column align-items-center pb-lg-5">
                <h3 class="fw-bold pt-5 mt-lg-5">About Us</h3>
            </div>
        <div class="container">
            <div class="row">
            <div class="col-lg-4 mb-lg-5 mt-4">
                ...
                <div class="card-body">
                    ...
                    clients generate circa 85% of the agency's overall income. We
                    are the main supplier of corporate travel services for more than
                    150 corporate clients (and growing) among which some of the most
                    important Iraqi and multinational corporations.
                    </p>
                </div>
                </div>
            </div>
            <div class="col-lg-4 mb-lg-5 mt-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                    It is a newly-designed system which provides B2B-B2C-B2E. <br />
                    It comprises all the technological modern features in developing
                    the tourist sciences and used air booking, hotel booking and
                    tourist programs.<br />
            ...
            <div class="col-lg-4 mb-lg-5 card-about-parent mt-4">
                ...
                <div class="card-body pb-5 line-about-card">
                    ...
                    contracts with Bravo.<br />
                    • Provide annual tourist programs.<br />
                    • Provide the White Label platform using the name of the company
